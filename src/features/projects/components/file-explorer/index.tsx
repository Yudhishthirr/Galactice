      ...
      <ScrollArea>
        ...
        >
          ...
          <div className="opacity-0 group-hover/project:opacity-100 transition-none duration-0 flex items-center gap-0.5 ml-auto">
            ...
            {/* this is the file button , when user click it open file input box */}
            <Button
              onClick={(e) => {
                e.stopPropagation();
                e.preventDefault();
            ...
            {/* this is the folder button , when user click it open folder input box */}
            <Button
              onClick={(e) => {
                e.stopPropagation();
                e.preventDefault();
            ...
            {/* it collepsus all the open file and folder */}
            <Button
              onClick={(e) => {
                e.stopPropagation();
                e.preventDefault();
        ...
        {/* acully code when user click on any folder or file we pass its type on this componet via this creating(file/folder) */}
        {isOpen && (
          <>
